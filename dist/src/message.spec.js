...
ava_1.test.serial('ready()', (t) => __awaiter(this, void 0, void 0, function* () {
...
// Issue #445
// XXX have to use test.serial() because mockGetContact can not be parallel
ava_1.test.serial('mentioned()', (t) => __awaiter(this, void 0, void 0, function* () {
    /* tslint:disable:max-line-length */
    ...
    const mockContactGetter = function (id) {
        return new Promise((resolve, reject) => {
            if (id !== ROOM_ID && !(id in CONTACT_LIST))
                return resolve({});
            if (id === ROOM_ID) {
                resolve(RAW_OBJ);
            }
    ...
    const msg12 = new message_1.default(rawObj12);
    ...
    const msg13 = new message_1.default(rawObj13);
    ...
    const msg21 = new message_1.default(rawObj21);
    ...
    const msg22 = new message_1.default(rawObj22);
    ...
    const msg31 = new message_1.default(rawObj31);
    ...
    const msg32 = new message_1.default(rawObj32);
