...
config_1.default.puppetInstance({
    userId: 'xxx',
});
ava_1.test('PuppetWebFriendRequest.receive smoke testing', t => {
...
`;
    ...
    const fr = new friend_request_1.default();
    ...
    t.true(fr.contact instanceof contact_1.default, 'should have a Contact instance');
    t.is(fr.type, 'receive', 'should be receive type');
});
ava_1.test('PuppetWebFriendRequest.confirm smoke testing', t => {
    /* tslint:disable:max-line-length */
    const rawMessageData = `
